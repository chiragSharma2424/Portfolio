    ...
    <section className="w-full flex ml-60 ">
      <div className="max-w-[800px] px-4">
        ...
        <p className="text-white text-xl leading-relaxed">
          ...
          and Java, and expertise in frameworks like React, MongoDB and Next.js. <br /><br />
          I'm a constant learner and always focus on developing new skills. I love building modern UI/UX
          and user-friendly solutions that solve real-world problems. <br /><br />
          <span className="font-semibold">Let's work together to bring your ideas to life!</span>
        </p>
      </div>
    </section>
  );
